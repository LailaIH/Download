...
Route::get('/admin-cp/job_titles/edit/{subId}', [SubscriptionController::class, 'edit'])->name('subscriptions.edit');
Route::put('/admin-cp/job_titles/update/{subId}', [SubscriptionController::class, 'update'])->name('subscriptions.update');
