...
<head>
    ...
    <title>Dashboard - Download Panel</title>
        ...
        <nav class="sidenav shadow-right sidenav-light">
            <div class="sidenav-menu">
                <div class="nav accordion" id="accordionSidenav">
                    ...
                    <div class="sidenav-menu-heading">Download Panel sections</div>
                    ...
                    <a class="nav-link collapsed" href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#collapsePages" aria-expanded="false" aria-controls="collapsePages">
                        <div class="nav-link-icon"><i class="fa-solid fa-video"></i></div>
                        Files
                        <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                    </a>
                    ...
                    <div class="page-header-content pt-4">
                        <div class="row align-items-center justify-content-between">
                            <div class="col-auto mt-4">
                                ...
                                <div class="page-header-subtitle">Example dashboard overview and content summary for Download Panel</div>
                            </div>
