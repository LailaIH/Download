                                ...
                                <div class="row align-items-center">
                                    <div class="col-xl-8 col-xxl-12">
                                        <div class="text-center text-xl-start text-xxl-center mb-4 mb-xl-0 mb-xxl-4">
                                            <h1 class="text-primary">Welcome to Download Panel System!</h1>
                                            <p class="text-gray-700 mb-0">Browse our fully Download Panel UI toolkit! Browse our prebuilt app pages, components, and sections, and be sure to look at our full documentation!</p>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xxl-4 col-xl-6 mb-4">
                        <div class="card card-header-actions h-100">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="small">
                                Download Panel expenses completed
